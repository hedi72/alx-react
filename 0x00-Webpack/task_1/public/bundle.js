        ...
        !(function (e, n) {
          ...
          !(function () {
            ...
            (e = C.expr =
              {
                ...
                pseudos: {
                  ...
                  lang: et(function (t) {
                    return (
                      F.test(t || "") || Q.error("unsupported lang: " + t),
            ...
            function ft(t, n) {
              ...
              for (a = t, c = [], s = e.preFilter; a; ) {
                ...
                (i = W.exec(a)) &&
                  ((r = i.shift()),
                  o.push({ value: r, type: i[0].replace(N, " ") }),
                  (a = a.slice(r.length))),
                e.filter))
                  !(i = B[u].exec(a)) ||
                    (s[u] && !(i = s[u](i))) ||
              ...
              return (
                ...
                et(function (o, u, a, c) {
                  var s,
                    ...
                    _ = !t || (!o && e) ? m : dt(m, d, t, a, c);
                  if (
                    (n
                      ? n(_, (h = i || (o ? t : y || r) ? [] : u), a, c)
                      : (h = _),
                    r)
                  )
                  ...
                  (function (t, r) {
                    var i = r.length > 0,
                      ...
                      u = function (u, a, s, f, p) {
                        ...
                        if (((y += _), i && _ !== y)) {
                          for (d = 0; (g = r[d++]); ) g(b, x, a, s);
                          if (u) {
                            if (y > 0)
                              for (; _--; ) b[_] || x[_] || (x[_] = E.call(f));
                            x = dt(x);
                          }
                          v.apply(f, x),
                            p &&
              ...
              function (t, e) {
                C.fn[t] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (U[t] || C.uniqueSort(i), B.test(t) && i.reverse()),
                    this.pushStack(i)
                  );
                };
              }
                              ...
                              : function () {
                                  try {
                                    ...
                                    C.Deferred.exceptionHook &&
                                      C.Deferred.exceptionHook(r, f.error),
                                      t + 1 >= o &&
                                        (n !== Y && ((a = void 0), (c = [r])),
                                        e.rejectWith(a, c));
                                  }
                ...
                if ("object" === w(o)) C.merge(p, o.nodeType ? [o] : o);
                  ...
                  for (
                    u = u || l.appendChild(e.createElement("div")),
                      ...
                      c = Et[a] || Et._default,
                      u.innerHTML = c[1] + C.htmlPrefilter(o) + c[2],
                      f = c[0];
                    f--;
          ...
          function Ht(t, e, n) {
            n
              ...
              : void 0 === at.get(t, e) && C.event.add(t, e, Rt);
          }
          (C.event = {
            global: {},
                ...
                for (s = (e = (e || "").match(V) || [""]).length; s--; )
                  if (
                    ...
                    u &&
                      ...
                      delete c[h]);
                  } else for (h in c) C.event.remove(t, h + e[s], n, r, !0);
                C.isEmptyObject(c) && at.remove(t, "handle events");
              }
            },
            dispatch: function (t) {
              var e,
              ...
              if (
                ...
                for (
                  u = C.event.handlers.call(this, c, s), e = 0;
            ...
            C.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
              ...
              (C.event.special[t] = {
                setup: function () {
                  var r;
                  if ((Ht(this, t, !0), !_.documentMode)) return !1;
          ...
          function Bt(t, e) {
            ...
            if (1 === e.nodeType) {
              ...
              ct.hasData(t) &&
                ((o = ct.access(t)), (u = C.extend({}, o)), ct.set(e, u));
            }
          }
          function Ut(t, e) {
          ...
          function Xt(t, e, n, r) {
            ...
            if (
              p &&
              ((o = (i = Nt(e, t[0].ownerDocument, !1, t, r)).firstChild),
              1 === i.childNodes.length && (i = o),
              o || r)
            ) {
              for (a = (u = C.map(St(i, "script"), zt)).length; l < p; l++)
                (s = i),
                  l !== h &&
                    ((s = C.clone(s, !0, !0)),
                    a && C.merge(u, St(s, "script"))),
                  n.call(t[l], s, l);
              if (a)
                for (
                  f = u[u.length - 1].ownerDocument, C.map(u, Ft), l = 0;
                  l < a;
                  l++
                )
                  (s = u[l]),
          ...
          function Vt(t, e, n) {
            for (
              ...
              n || 1 !== r.nodeType || C.cleanData(St(r)),
                r.parentNode &&
            ...
            C.fn.extend({
              ...
              empty: function () {
                for (var t, e = 0; null != (t = this[e]); e++)
                  1 === t.nodeType &&
                    (C.cleanData(St(t, !1)), (t.textContent = ""));
                return this;
              },
              clone: function (t, e) {
                return (
                  ...
                  function (t) {
                    ...
                    if (
                      ...
                      try {
                        for (; n < r; n++)
                          1 === (e = this[n] || {}).nodeType &&
                            (C.cleanData(St(e, !1)), (e.innerHTML = t));
                        e = 0;
                      } catch (t) {}
                    }
              ...
              replaceWith: function () {
                ...
                return Xt(
                  ...
                  function (e) {
                    ...
                    C.inArray(this, t) < 0 &&
                      (C.cleanData(St(this)), n && n.replaceChild(e, this));
                  },
                  t
                );
              },
          ...
          function Qt(t, e, n) {
            ...
            return (
              (n = n || Kt(t)) &&
                ...
                a && u && (u = u.replace(N, "$1") || void 0),
                "" !== u || gt(t) || (u = C.style(t, e)),
                !g.pixelBoxStyles() &&
                  Gt.test(u) &&
                  Jt.test(e) &&
                  ((r = c.width),
          ...
          function se(t, e, n, r, i, o) {
            ...
            for (; u < 4; u += 2)
              "margin" === n && (s += C.css(t, n + dt[u], !0, i)),
                r
                  ? ("content" === n &&
                      (c -= C.css(t, "padding" + dt[u], !0, i)),
                    "margin" !== n &&
                      (c -= C.css(t, "border" + dt[u] + "Width", !0, i)))
                  : ((c += C.css(t, "padding" + dt[u], !0, i)),
                    "padding" !== n
                      ? (c += C.css(t, "border" + dt[u] + "Width", !0, i))
                      : (a += C.css(t, "border" + dt[u] + "Width", !0, i)));
            return (
              !r &&
                o >= 0 &&
                (c +=
          ...
          function be(t, e, n) {
            ...
            for (
              ...
              if ((r = be.prefilters[o].call(s, t, f, s.opts)))
                return (
                  y(r.stop) &&
            ...
            return (
              ...
              C.fx.timer(
                C.extend(c, { elem: t, anim: s, queue: s.opts.queue })
              ),
              s
            );
          }
                  ...
                  ? this.each(function () {
                      if (
                        ...
                        for (o = 0; o < e.length; o++)
                          (i = e[o]),
                            n.indexOf(" " + i + " ") < 0 && (n += i + " ");
                        (u = Ce(n)), r !== u && this.setAttribute("class", u);
                      }
                    })
                  : this;
              },
                    ...
                    l
                      ? (h.ifModified &&
                        ...
                        204 === t || "HEAD" === h.type
                          ...
                          : 304 === t
                          ? (w = "notmodified")
                          : ((w = b.state), (p = b.data), (l = !(_ = b.error))))
                      : ((_ = w),
                        (!t && w) || ((w = "error"), t < 0 && (t = 0))),
                    (T.status = t),
                    (T.statusText = (e || w) + ""),
          ...
          C.ajaxSetup({
            ...
            C.each(["top", "left"], function (t, e) {
              C.cssHooks[e] = te(g.pixelPosition, function (t, n) {
                if (n)
                  return (
                    (n = Qt(t, e)), Gt.test(n) ? C(t).position()[e] + "px" : n
                  );
              });
            }),
          ...
          function () {
            var i,
              ...
              Vt =
                ...
                ")*",
              Gt = "(?:" + [Nt, Ht, Mt].join("|") + ")" + Vt,
              Yt = "(?:" + [It + Dt + "?", Dt, Ht, Mt, Et].join("|") + ")",
              Kt = RegExp("['’]", "g"),
              Zt = RegExp(Dt, "g"),
              Jt = RegExp(qt + "(?=" + qt + ")|" + Yt + Vt, "g"),
              Qt = RegExp(
                [
                  Pt +
                    "?" +
            ...
            var hn = Be({
              ...
              dn = (function t(e) {
                var n,
                  ...
                  $t = e.Symbol,
                  zt = e.Uint8Array,
                  Ft = Wt ? Wt.allocUnsafe : i,
                  Bt = un(jt.getPrototypeOf, jt),
                  Ut = jt.create,
                  Xt = Dt.propertyIsEnumerable,
                  Vt = Et.splice,
                  Gt = $t ? $t.isConcatSpreadable : i,
                  Yt = $t ? $t.iterator : i,
                ...
                function Kn(t, e) {
                  return No(ki(t), or(e, 0, t.length));
                }
                function Zn(t) {
                  return No(ki(t));
                }
                ...
                function Ar(t, e, n) {
                  ...
                  t: for (; ++h < u && l.length < f; ) {
                    var v = p[h],
                      g = e ? e(v) : v;
                    if (
                      ((v = n || 0 !== v ? v : 0), !(d ? Ze(d, g) : o(l, g, n)))
                    ) {
                      for (c = a; --c; ) {
                        var y = s[c];
                        if (!(y ? Ze(y, g) : o(t[c], g, n))) continue t;
                      }
                      d && d.push(g), l.push(v);
                    }
                  }
                ...
                function Er(t, e, n) {
                  var r =
                    null == (t = Co(t, (e = gi(e, t)))) ? t : t[Io(Yo(e))];
                      ...
                      : (function (t, e, n, r, o, u) {
                          ...
                          if (!(1 & n)) {
                            var d = l && Lt.call(t, "__wrapped__"),
                              b = p && Lt.call(e, "__wrapped__");
                            if (d || b) {
                              var x = d ? t.value() : t,
                                C = b ? e.value() : e;
                              return u || (u = new Vn()), o(x, C, n, r, u);
                            }
                          }
                          return (
                            !!h &&
                ...
                function ci(t, e) {
                  return (
                    null == (t = Co(t, (e = gi(e, t)))) || delete t[Io(Yo(e))]
                  );
                }
                function si(t, e, n, r) {
                  return Kr(t, e, n(xr(t, e)), r);
                }
                function fi(t, e, n, r) {
                  for (
                ...
                function gi(t, e) {
                  return Fu(t) ? t : mo(t, e) ? [t] : qo(ya(t));
                }
                var yi = Vr;
                function mi(t, e, n) {
                  var r = t.length;
                ...
                function Oi(t) {
                  return function (e, n, r) {
                    for (var i = -1, o = jt(e), u = r(e), a = u.length; a--; ) {
                      var c = u[t ? a : ++i];
                ...
                function Li(t) {
                  return function (e) {
                    return Le(Ka(za(e).replace(Kt, "")), t, "");
                  };
                }
                function Ri(t) {
                  return function () {
                ...
                function Hi(t, e, n, o, u, a, c, f, l, p) {
                  ...
                  return function s() {
                    ...
                    if (
                      ...
                      var j = an(b, w);
                      return Bi(t, e, Hi, s.placeholder, n, b, j, f, l, p - _);
                    }
                    var C = d ? n : this,
                      k = v ? C[t] : t;
                    return (
                ...
                function Bi(t, e, n, r, o, u, a, s, f, l) {
                  ...
                  var h = [
                    ...
                    d = n.apply(i, h);
                  return _o(t) && Ao(d, h), (d.placeholder = r), Do(d, t, e);
                }
                function Ui(t) {
                  var e = Tt[t];
                  return function (t, n) {
                ...
                function Ki(t, e, n, r, o, u) {
                  return (
                    Qu(t) &&
                      Qu(e) &&
                      (u.set(e, t), Pr(t, e, i, Ki, u), u.delete(e)),
                    t
                  );
                }
                function Zi(t) {
                ...
                ((wn && lo(new wn(new ArrayBuffer(1))) != N) ||
                  (Tn && lo(new Tn()) != w) ||
                  (jn && lo(jn.resolve()) != C) ||
                  (Cn && lo(new Cn()) != A) ||
                  (kn && lo(new kn()) != D)) &&
                ...
                var ou = Vr(function (t, e) {
                  ...
                  au = Vr(function (t) {
                    var e = Yo(t);
                    return Xu(e) && (e = i), pi(Ee(t, Xu), oo(e, 2));
                  }),
                  cu = Vr(function (t) {
                    var e = Yo(t);
                    return (
                      (e = "function" == typeof e ? e : i), pi(Ee(t, Xu), i, e)
                    );
                  }),
                  su = Vr(ru),
                  fu = Vr(function (t) {
                ...
                var hu = Qi(function (t) {
                  ...
                  du = Ei(function (t, e, n) {
                    Lt.call(t, n) ? ++t[n] : rr(t, n, 1);
                  }),
                  vu = qi(zo),
                  gu = qi(Fo);
                function yu(t, e) {
                  return (Fu(t) ? Ce : fr)(t, oo(e, 3));
                }
                function mu(t, e) {
                  return (Fu(t) ? ke : lr)(t, oo(e, 3));
                }
                var _u = Ei(function (t, e, n) {
                    Lt.call(t, n) ? t[n].push(e) : rr(t, n, [e]);
                  }),
                  bu = Vr(function (t, e, n) {
                    var i = -1,
                      o = "function" == typeof e,
                      u = Uu(t) ? r(t.length) : [];
                    return (
                      fr(t, function (t) {
                        u[++i] = o ? Te(e, t, n) : Er(t, e, n);
                      }),
                      u
                    );
                  }),
                  xu = Ei(function (t, e, n) {
                    rr(t, n, e);
                  });
                function wu(t, e) {
                  return (Fu(t) ? Oe : Ir)(t, oo(e, 3));
                }
                var Tu = Ei(
                    function (t, e, n) {
                      t[n ? 0 : 1].push(e);
                ...
                function Du(t, e, n) {
                  ...
                  function _() {
                    ...
                    if (((r = arguments), (u = this), (f = t), n)) {
                      if (s === i)
                        return (function (t) {
                          return (l = t), (s = Eo(y, e)), p ? v(t) : c;
                        })(f);
                      if (h) return _i(s), (s = Eo(y, e)), v(f);
                    }
                    return s === i && (s = Eo(y, e)), c;
                  }
                  return (
                    (e = va(e) || 0),
                    Qu(n) &&
                ...
                function Uu(t) {
                  return null != t && Ju(t.length) && !Ku(t);
                }
                function Xu(t) {
                  return ta(t) && Uu(t);
                }
                ...
                function ra(t) {
                  if (!ta(t) || Tr(t) != j) return !1;
                  var e = Bt(t);
                  if (null === e) return !0;
                  var n = Lt.call(e, "constructor") && e.constructor;
                  return (
                    "function" == typeof n && n instanceof n && Nt.call(n) == Ht
                  );
                }
                var ia = be
                    ? Ye(be)
                ...
                function ua(t) {
                  return (
                    "string" == typeof t || (!Fu(t) && ta(t) && Tr(t) == E)
                  );
                }
                function aa(t) {
                  return "symbol" == typeof t || (ta(t) && Tr(t) == S);
                }
                var ca = we
                    ? Ye(we)
                    : function (t) {
                ...
                var ma = Si(function (t, e) {
                  ...
                  ba = Si(function (t, e, n, r) {
                    Ai(e, Oa(e), t, r);
                  }),
                  xa = Si(function (t, e, n, r) {
                    Ai(e, Da(e), t, r);
                  }),
                  wa = Qi(ir),
                  Ta = Vr(function (t, e) {
                    ...
                    for (o && yo(e[0], e[1], o) && (r = 1); ++n < r; )
                      for (
                        var u = e[n], a = Oa(u), c = -1, s = a.length;
                        ++c < s;
                ...
                function za(t) {
                  return (t = ya(t)) && t.replace(mt, tn).replace(Zt, "");
                }
                var Fa = Li(function (t, e, n) {
                ...
                var Za = Vr(function (t, e) {
                    try {
                      ...
                      return Yu(t) ? t : new xt(t);
                    }
                  }),
                  Ja = Qi(function (t, e) {
                    return (
                      Ce(e, function (e) {
                        (e = Io(e)), rr(t, e, Eu(t[e], t));
                      }),
                      t
                    );
                  });
                ...
                return (
                  ...
                  (Mn.functions = function (t) {
                    return null == t ? [] : br(t, Da(t));
                  }),
                  (Mn.functionsIn = function (t) {
                    return null == t ? [] : br(t, Oa(t));
                  }),
                  (Mn.groupBy = _u),
                  ...
                  (Mn.toPath = function (t) {
                    return Fu(t) ? Oe(t, Io) : aa(t) ? [t] : ki(qo(ya(t)));
                  }),
                  (Mn.toPlainObject = ga),
                  ...
                  (Mn.escape = function (t) {
                    return (t = ya(t)) && G.test(t) ? t.replace(X, en) : t;
                  }),
                  ...
                  (Mn.findLastKey = function (t, e) {
                    return He(t, oo(e, 3), _r);
                  }),
                  (Mn.floor = bc),
                  (Mn.forEach = yu),
                  (Mn.forEachRight = mu),
                  (Mn.forIn = function (t, e) {
                    return null == t ? t : gr(t, oo(e, 3), Oa);
                  }),
                  (Mn.forInRight = function (t, e) {
                    return null == t ? t : yr(t, oo(e, 3), Oa);
                  }),
                  ...
                  (Mn.isMatchWith = function (t, e, n) {
                    return (
                      (n = "function" == typeof n ? n : i), Or(t, e, ao(e), n)
                    );
                  }),
                  (Mn.isNaN = function (t) {
                    return na(t) && t != +t;
                  ...
                  (Mn.lte = fa),
                  (Mn.max = function (t) {
                    return t && t.length ? hr(t, nc, jr) : i;
                  }),
                    ...
                    if ((a && (c += s.length - c), ia(o))) {
                      if (t.slice(c).search(o)) {
                        var f,
                          l = s;
                        for (
                          o.global || (o = Ct(o.source, ya(pt.exec(o)) + "g")),
                            o.lastIndex = 0;
                          (f = o.exec(l));
                  ...
                  (zn.prototype.invokeMap = Vr(function (t, e) {
                    return "function" == typeof t
                      ? new zn(this)
                      : this.map(function (n) {
                          return Er(n, t, e);
                  ...
                  (Sn[Hi(i, 2).name] = [{ name: "wrapper", func: i }]),
  ...
  (n.g = (function () {
    ...
    (() => {
      ...
      t("body").append("<p>Holberton Dashboard</p>"),
        ...
        t("body").append("<button>Click here to get started</button>"),
        t("body").append("<p id='count'></p>"),
        t("body").append("<p>Copyright - Holberton School</p>");
      const i = e.debounce(function () {
        r++, t("#count").html(`${r} clicks on the button`);
      }, 500);
      t("button").on("click", i);
    })();
})();
